#### Estimate power using the power estimators and then combine the estimated power with the empirical power.
#### Final output: ../../results/3cat/power_comparison_z_u_ricc_052426.csv
library(dplyr)
library(readr)
library(geepack)
library(ordinal)
...
# power_results1 %>% write_csv("../../results/3cat/est_power_022526.csv")

emp_power = read_csv("../../results/3cat/emp_power_all_addushape052426.csv") %>%
...
final_results1 %>% 
  write_csv("../../results/3cat/power_comparison_z_u_ricc_052426.csv")
