...
## output: results/4cat/rhomat_from_superpop_4cat.csv
...
scenarios_for_super_pop = read_csv("../../results/4cat/superpop/scenarios_for_superpop_updated_beta1.5_4cat.csv")
...
final_out %>% 
  write_csv("../../results/4cat/rhomat_from_superpop_4cat.csv")
