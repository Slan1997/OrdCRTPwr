...
out_full <- read_csv("../../results/4cat/power_comparison_4cat_052426.csv") %>%
  select(
...
df_fmt %>% dplyr::select(-min_diff) %>%
  write_csv("../../manuscript_tables_and_figures/Supplementary/Supplementary_Table_S4.csv")
