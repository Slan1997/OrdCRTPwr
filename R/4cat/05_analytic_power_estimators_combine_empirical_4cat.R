#### Estimate power using the power estimators (using collapsed 3-category outcomes) and then combine the estimated power with the empirical power.
#### Final output: ../../results/4cat/power_comparison_4cat_052426.csv
library(dplyr)
library(readr)
library(geepack)
library(ordinal)
...
emp_power = read_csv("../../results/4cat/emp_power_all_4cat_052426.csv") %>%
...
final_results1 %>% 
  write_csv("../../results/4cat/power_comparison_4cat_052426.csv")
