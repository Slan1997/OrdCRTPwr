...
## output: results/3cat/rhomat_from_superpop.csv
...
library(ordinal)
library(bridgedist)
source("../functions/bridge_helpers.R")
...
scenarios_for_super_pop = read_csv("../../results/3cat/superpop/scenarios_for_superpop_3cat.csv")
...
# #### per scenario results are saved in an ACCRE directory. 
...
# #### A combined results were obtained through following codes:
# library(dplyr)
# library(readr)
# result_path = "~/Composite_Endpoints/proj2_setup_011926/results/superpop_rhomat/"
# 
# scenarios_for_super_pop = read_csv("scenarios_for_superpop_3cat.csv")
